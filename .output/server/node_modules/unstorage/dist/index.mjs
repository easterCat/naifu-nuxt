...
<<<<<<< HEAD
import { a as asyncCall, d as deserializeRaw, s as stringify, b as serializeRaw } from './shared/unstorage.e9bf0023.mjs';
=======
...
>>>>>>> dev
    ...
    getItem(key, opts = {}) {
      ...
      const { relativeKey, driver } = getMount(key);
<<<<<<< HEAD
      return asyncCall(driver.getItem, relativeKey).then(
        (value) => destr(value)
      );
    },
    getItemRaw(key) {
