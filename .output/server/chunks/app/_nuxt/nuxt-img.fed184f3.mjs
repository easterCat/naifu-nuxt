import { C as Cn, K, U } from '../server.mjs';
...
const u = () => U().$img, n = { src: { type: String, required: true }, format: { type: String, default: void 0 }, quality: { type: [Number, String], default: void 0 }, background: { type: String, default: void 0 }, fit: { type: String, default: void 0 }, modifiers: { type: Object, default: void 0 }, preset: { type: String, default: void 0 }, provider: { type: String, default: void 0 }, sizes: { type: [Object, String], default: void 0 }, preload: { type: Boolean, default: void 0 }, width: { type: [String, Number], default: void 0 }, height: { type: [String, Number], default: void 0 }, alt: { type: String, default: void 0 }, referrerpolicy: { type: String, default: void 0 }, usemap: { type: String, default: void 0 }, longdesc: { type: String, default: void 0 }, ismap: { type: Boolean, default: void 0 }, loading: { type: String, default: void 0 }, crossorigin: { type: [Boolean, String], default: void 0, validator: (e2) => ["anonymous", "use-credentials", "", true, false].includes(e2) }, decoding: { type: String, default: void 0, validator: (e2) => ["async", "auto", "sync"].includes(e2) } }, p = (e2) => ({ options: computed(() => ({ provider: e2.provider, preset: e2.preset })), attrs: computed(() => ({ width: Cn(e2.width), height: Cn(e2.height), alt: e2.alt, referrerpolicy: e2.referrerpolicy, usemap: e2.usemap, longdesc: e2.longdesc, ismap: e2.ismap, crossorigin: true === e2.crossorigin ? "anonymous" : e2.crossorigin || void 0, loading: e2.loading, decoding: e2.decoding })), modifiers: computed(() => ({ ...e2.modifiers, width: Cn(e2.width), height: Cn(e2.height), format: e2.format, quality: e2.quality, background: e2.background, fit: e2.fit })) }), v = { ...n, placeholder: { type: [Boolean, String, Number, Array], default: void 0 } }, f = defineComponent({ name: "NuxtImg", props: v, setup: (e2, o2) => {
  const n2 = u(), v2 = p(e2), f2 = ref(false), g2 = computed(() => n2.getSizes(e2.src, { ...v2.options.value, sizes: e2.sizes, modifiers: { ...v2.modifiers.value, width: Cn(e2.width), height: Cn(e2.height) } })), c = computed(() => {
