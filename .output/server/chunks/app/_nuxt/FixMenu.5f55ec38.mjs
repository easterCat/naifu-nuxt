...
const u = defineComponent({ __name: "FixMenu", __ssrInlineRender: true, setup: (e2) => (ref(false), (e3, n2, i2, a2) => {
  const u2 = I, c2 = t, l2 = n;
  n2(`<div${ssrRenderAttrs(mergeProps({ class: "page-fix-menu" }, a2))} data-v-63c719a1><button class="hover-anime-btn btn btn-sm btn-accent btn-circle" data-v-63c719a1>`), n2(ssrRenderComponent(u2, { name: "entypo:brush" }, null, i2)), n2('</button><button class="hover-anime-btn btn btn-sm btn-primary btn-circle" data-v-63c719a1>'), n2(ssrRenderComponent(c2, null, null, i2)), n2("</button>"), n2(ssrRenderComponent(l2, null, null, i2)), n2("</div>");
}) }), c = u.setup;
u.setup = (t2, o2) => {
