<template>
    <div class="tranfer-con">
        <div class="button-con">
            <button class="btn btn-accent btn-sm m-r-10 m-b-10" @click="promptFormat">
                格式化
            </button>
            <button class="btn btn-accent btn-sm m-r-10 m-b-10" @click="clearPrompt">清空</button>
            <button class="btn btn-accent btn-sm m-r-10 m-b-10" @click="mediumToCircle">
                大括号转圆括号
            </button>
            <button class="btn btn-accent btn-sm m-r-10 m-b-10" @click="circleToMedium">
                圆括号转大括号
            </button>
            <button class="btn btn-accent btn-sm m-r-10 m-b-10" @click="addHighQualityPrompt">
                起手式
            </button>
            ...
            <button class="btn btn-accent btn-sm m-b-10" @click="promotRemoveLine">
                去除下划线(用于danbooru)
            </button>
        </div>
        ...
        <div v-if="promptHistory && promptHistory?.length" class="history-con">
            <div class="button-con">
                <button class="btn btn-md btn-accent btn-sm m-b-15" @click="clearHistory">
                    清空历史
                </button>
            </div>
