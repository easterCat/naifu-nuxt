...
const z = defineComponent({ __name: "promptBeautiful", __ssrInlineRender: true, setup(o2) {
  ...
  return (a2, o3, e2, i2) => {
    ...
    o3(`<div${ssrRenderAttrs(mergeProps({ class: "tranfer-con" }, i2))} data-v-14689905><div class="button-con" data-v-14689905><button class="btn btn-accent btn-sm m-r-10 m-b-10" data-v-14689905> \u683C\u5F0F\u5316 </button><button class="btn btn-accent btn-sm m-r-10 m-b-10" data-v-14689905>\u6E05\u7A7A</button><button class="btn btn-accent btn-sm m-r-10 m-b-10" data-v-14689905> \u5927\u62EC\u53F7\u8F6C\u5706\u62EC\u53F7 </button><button class="btn btn-accent btn-sm m-r-10 m-b-10" data-v-14689905> \u5706\u62EC\u53F7\u8F6C\u5927\u62EC\u53F7 </button><button class="btn btn-accent btn-sm m-r-10 m-b-10" data-v-14689905> \u8D77\u624B\u5F0F </button><button class="btn btn-accent btn-sm m-r-10 m-b-10" data-v-14689905> \u8D2D\u7269\u8F66\u5BFC\u5165 </button><button class="btn btn-accent btn-sm m-r-10 m-b-10" data-v-14689905> \u5BFC\u51FA\u8D2D\u7269\u8F66 </button><button class="btn btn-accent btn-sm m-r-10 m-b-10" data-v-14689905> \u7A7A\u683C\u52A0\u9017\u53F7(\u7528\u4E8Edanbooru) </button><button class="btn btn-accent btn-sm m-b-10" data-v-14689905> \u53BB\u9664\u4E0B\u5212\u7EBF(\u7528\u4E8Edanbooru) </button></div>`), o3(ssrRenderComponent(I, { gutter: 20 }, { default: withCtx((t2, a3, o4, e3) => {
      if (!a3)
    ...
    }), _: 1 }, e2)), o3(ssrRenderComponent(A, { title: "Prompt\u5217\u8868" }, null, e2)), unref(z2) && (null == (b2 = unref(z2)) ? void 0 : b2.length) ? (o3('<div class="tags-con" data-v-14689905><div class="m-b-10" data-v-14689905><button class="btn btn-md btn-accent" data-v-14689905> \u5F53\u524Dtags\u66FF\u6362prompt </button></div><!--[-->'), ssrRenderList(unref(z2), (t2, a3) => {
      o3(`<button class="btn btn-sm btn-secondary m-r-10 m-b-10" data-v-14689905>${ssrInterpolate(t2)}</button>`);
    }), o3("<!--]--></div>")) : o3('<div class="tags-con" data-v-14689905><p class="no-data" data-v-14689905>\u6682\u65E0\u5217\u8868</p></div>'), o3(ssrRenderComponent(A, { title: "Prompt\u8BB0\u5F55" }, { titleSide: withCtx((t2, a3, o4, e3) => {
      if (!a3)
        return [createVNode("span", { class: "title-side" }, "\u603B\u6570:" + toDisplayString(unref(k2)) + "\u6761", 1)];
      a3(`<span class="title-side" data-v-14689905${e3}>\u603B\u6570:${ssrInterpolate(unref(k2))}\u6761</span>`);
    }), _: 1 }, e2)), unref(R2) && (null == (C2 = unref(R2)) ? void 0 : C2.length) ? (o3('<div class="history-con" data-v-14689905><div class="button-con" data-v-14689905><button class="btn btn-md btn-accent btn-sm m-b-15" data-v-14689905> \u6E05\u7A7A\u5386\u53F2 </button></div><!--[-->'), ssrRenderList(unref(R2), (t2, l2) => {
      o3(`<div class="history-item" data-v-14689905><p style="${ssrRenderStyle({ "font-weight": "bold", "margin-bottom": "4px" })}" data-v-14689905>`), o3(0 === l2 ? ssrRenderComponent(T, { style: { color: "#67c23a", "font-size": "12px" } }, null, e2) : "<!---->"), o3(`<span data-v-14689905>${ssrInterpolate(null == t2 ? void 0 : t2.time)}</span></p><p data-v-14689905>${ssrInterpolate(null == t2 ? void 0 : t2.prompt)}</p><div class="history-button" data-v-14689905><button class="btn btn-sm btn-secondary m-r-10" data-v-14689905>`), ssrRenderSlot(a2.$slots, "icon", {}, () => {
        o3(ssrRenderComponent(q, { class: "m-r-4" }, null, e2));
      }, o3, e2), o3(' \u5220\u9664 </button><button class="btn btn-sm btn-accent m-r-10" data-v-14689905>'), ssrRenderSlot(a2.$slots, "icon", {}, () => {
        o3(ssrRenderComponent(D, { class: "m-r-4" }, null, e2));
      }, o3, e2), o3(' \u590D\u5236 </button><button class="btn btn-sm btn-primary m-r-10" data-v-14689905>'), ssrRenderSlot(a2.$slots, "icon", {}, () => {
        o3(ssrRenderComponent(E, { class: "m-r-4" }, null, e2));
      }, o3, e2), o3(" \u9009\u62E9 </button></div></div>");
    }), o3("<!--]--></div>")) : o3('<div class="tags-con" data-v-14689905><p class="no-data" data-v-14689905>\u6682\u65E0\u8BB0\u5F55</p></div>'), o3("</div>");
  };
} }), R = z.setup;
z.setup = (t2, a2) => {
...
const k = di(z, [["__scopeId", "data-v-14689905"]]);
