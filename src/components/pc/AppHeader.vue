        ...
        <div class="header-con">
            <div class="header-menu">
                ...
                <div class="my-menu">
                    ...
                    >
                        <Icon name="ant-design:home-filled" size="22"></Icon>
                        <span v-if="screenSize === 'large'">首页</span>
                    </span>
                    <span
                        class="menu-item"
                    ...
                    >
                        <Icon name="ant-design:tag-filled" size="22"></Icon>
                        <span v-if="screenSize === 'large'">标签</span>
                    ...
                    >
                        <Icon name="heroicons-solid:template" size="22" />
                        <span v-if="screenSize === 'large'">SFW模版</span>
                    </span>
                    <span
                    ...
                    >
                        <Icon name="material-symbols:18-up-rating" size="22" />
                        <span v-if="screenSize === 'large'">NSFW模版</span>
                    </span>
                    <span
                        class="menu-item"
                    ...
                    >
                        <Icon name="icon-park-solid:tool" size="20"></Icon>
                        <span v-if="screenSize === 'large'">工具</span>
                    </span>
                    <span
                        class="menu-item"
                    ...
                    >
                        <Icon name="fluent:link-square-12-filled" size="22" />
                        <span v-if="screenSize === 'large'">收录</span>
                    </span>
                </div>
            </div>
            <div class="user-info">
