...
import { Y, T as Tn, d as di } from '../server.mjs';
...
const D = defineComponent({ __name: "eHentaiMore", __ssrInlineRender: true, props: { searchText: { type: String, default: "" } }, setup(o2) {
  const k2 = o2, { EhttApi: E2 } = A(), { copy: D2 } = s(), { addShop: I2 } = p(), J2 = Y(), N = ref(false), O = ref(false), W = ref(1), q = ref(20), B = ref(0), F = ref("hidden"), G = ref(""), K = ref([]);
  let P = reactive([]), Q = reactive([]), X = reactive([]), Y$1 = reactive([]), Z = reactive({ data: [] });
  const ee = new Worker("/naifu/worker.js");
  ...
  return (l2, a2, t2, n2) => {
    ...
    a2(`<div${ssrRenderAttrs(mergeProps({ class: "eh-con" }, n2))} data-v-ea0f0f30>`), a2(ssrRenderComponent(o3, { title: "EH\u8D85\u591A\u6807\u7B7E\u5217\u8868" }, { titleSide: withCtx((e2, l3, a3, t3) => {
      if (!l3)
      ...
      l3(ssrRenderComponent(i2, { modelValue: N.value, "onUpdate:modelValue": (e3) => N.value = e3, size: "large", "inline-prompt": "", "inactive-text": "\u9690\u85CF", "active-text": "\u5F00\u542F", class: "title-side" }, null, a3, t3)), l3(`<span class="eh-title-side-tip" data-v-ea0f0f30${t3}>(31813\u4E2A\u6807\u7B7E\u7248\u672C,\u9AD8h,\u614E\u91CD)</span>`);
    }), _: 1 }, t2)), N.value ? (a2('<div class="flex justify-between m-b-10" data-v-ea0f0f30>'), a2(ssrRenderComponent(u2, { modelValue: G.value, "onUpdate:modelValue": (e2) => G.value = e2, class: "m-2", placeholder: "\u547D\u540D\u7A7A\u95F4", size: "large" }, { default: withCtx((e2, l3, a3, t3) => {
      if (!l3)
    ...
    }), _: 1 }, t2)), a2(`<div class="control-blur-btns" data-v-ea0f0f30><button class="${ssrRenderClass([["hidden" === F.value ? "btn-accent" : "btn-secondary-30"], "btn btn-sm m-r-10"])}" data-v-ea0f0f30> \u9690\u85CF </button><button class="${ssrRenderClass([["flur" === F.value ? "btn-accent" : "btn-secondary-30"], "btn btn-sm m-r-10"])}" data-v-ea0f0f30> \u6A21\u7CCA </button><button class="${ssrRenderClass([["show" === F.value ? "btn-accent" : "btn-secondary-30"], "btn btn-sm m-r-10"])}" data-v-ea0f0f30> \u7F29\u5C0F </button><button class="${ssrRenderClass([["default" === F.value ? "btn-accent" : "btn-secondary-30"], "btn btn-sm"])}" data-v-ea0f0f30> \u539F\u56FE </button></div></div>`)) : a2("<!---->"), N.value ? a2(ssrRenderComponent(k3, { class: "m-b-10", data: unref(Y$1), border: "", stripe: "", size: "large", style: { width: "100%" } }, { default: withCtx((e2, a3, t3, n3) => {
      if (!a3)
      ...
      a3(ssrRenderComponent(A2, { prop: "namespace", label: "\u547D\u540D\u7A7A\u95F4", width: "130" }, null, t3, n3)), a3(ssrRenderComponent(A2, { prop: "key", label: "\u539F\u59CB\u6807\u7B7E", width: "270" }, { default: withCtx((e3, a4, t4, n4) => {
        ...
        a4(`<span class="m-r-12" data-v-ea0f0f30${n4}>${ssrInterpolate((null == (o4 = e3.row) ? void 0 : o4.key) || "")}</span>`), a4(ssrRenderComponent(E3, { size: "small", circle: "", onClick: (l3) => {
          var a5;
          return unref(I2)((null == (a5 = e3.row) ? void 0 : a5.key) || "");
        ...
        l3(`<div class="${ssrRenderClass([{ "show-img": "show" === F.value, "hidden-img": "hidden" === F.value, "flur-img": "flur" === F.value, "default-img": "default" === F.value }, "table-intro"])}" data-v-ea0f0f30${t4}>${(null == (i3 = null == (o4 = null == (n4 = e3.row) ? void 0 : n4.value) ? void 0 : o4.intro) ? void 0 : i3.html) || ""}</div>`);
        ...
        l3(`<div data-v-ea0f0f30${t4}>${(null == (i3 = null == (o4 = null == (n4 = e3.row) ? void 0 : n4.value) ? void 0 : o4.links) ? void 0 : i3.html.replace(/(<a)/g, "<a target='_blank'")) || ""}</div>`);
      }), _: 1 }, t3, n3));
    }), _: 3 }, t2)) : a2("<!---->"), N.value ? (a2('<div class="demo-pagination-block" data-v-ea0f0f30>'), a2(ssrRenderComponent(P2, { "current-page": W.value, "onUpdate:current-page": (e2) => W.value = e2, "page-size": q.value, "onUpdate:page-size": (e2) => q.value = e2, "page-sizes": [20, 50, 100], background: true, layout: "total, sizes, prev, pager, next, jumper", total: B.value, onSizeChange: ae, onCurrentChange: te }, null, t2)), a2("</div>")) : a2("<!---->"), a2("</div>");
  };
} }), I = D.setup;
D.setup = (e2, l2) => {
  const a2 = useSSRContext();
  return (a2.modules || (a2.modules = /* @__PURE__ */ new Set())).add("pages/mobile/tags/components/eHentaiMore.vue"), I ? I(e2, l2) : void 0;
};
const J = di(D, [["__scopeId", "data-v-ea0f0f30"]]);
