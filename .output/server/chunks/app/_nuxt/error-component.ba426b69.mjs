...
const a = { __name: "nuxt-error-page", __ssrInlineRender: true, props: { error: Object }, setup(s2) {
  ...
  const u2 = Number(o2.statusCode || 500), l = 404 === u2, d = null != (a2 = o2.statusMessage) ? a2 : l ? "Page Not Found" : "Internal Server Error", p = o2.message || o2.toString(), c = defineAsyncComponent(() => import('./error-404.cc2ab678.mjs').then((e2) => e2.default || e2)), i = defineAsyncComponent(() => import('./error-500.b5ea09e9.mjs').then((e2) => e2.default || e2)), m = l ? c : i;
  return (e2, s3, a3, o3) => {
    s3(ssrRenderComponent(unref(m), mergeProps({ statusCode: unref(u2), statusMessage: unref(d), description: unref(p), stack: unref(void 0) }, o3), null, a3));
  };
} }, o = a.setup;
a.setup = (e2, r2) => {
