...
import U from './imageAnalysis.a28bf575.mjs';
...
const a = defineComponent({ __name: "index", __ssrInlineRender: true, setup(e2) {
  var p2;
  shallowRef(U);
  ref(0);
  const n2 = ref(a$1);
...
a.setup = (o2, e2) => {
  ...
  return (t2.modules || (t2.modules = /* @__PURE__ */ new Set())).add("pages/pc/utils/index.vue"), d ? d(o2, e2) : void 0;
};
const f = di(a, [["__scopeId", "data-v-0869a419"]]);
