...
import { R, T as Tn, d as di } from '../server.mjs';
...
const B = defineComponent({ __name: "gelbooru", __ssrInlineRender: true, props: { searchText: { type: String, default: "" } }, async setup(a2) {
  let _2, A2;
  const B2 = a2, E2 = R().public.GELBOORU_TOKEN, { GelbooruApi: F2 } = A(), { copy: L } = s(), { addShop: R$1 } = p(), V = ref([]), W = ref([]), K = ref([]), q = ref(1100), D = ref(1), H = ref(100), J = ref(0), M = ([_2, A2] = withAsyncContext(() => F2.getList()), _2 = await _2, A2(), _2);
  ...
  return (l2, a3, o2, t2) => {
    ...
    a3(`<div${ssrRenderAttrs(mergeProps({ class: "eh-con" }, t2))} data-v-88d54171>`), a3(ssrRenderComponent(r2, { title: "Gelbooru\u6807\u7B7E\u5217\u8868" }, { titleSide: withCtx((e2, l3, a4, o3) => {
      if (!l3)
        return [createVNode("span", { class: "eh-title-side-tip" }, "(\u5206\u7C7B\u4E0D\u597D\u7528,\u7528\u641C\u7D22)")];
      l3(`<span class="eh-title-side-tip" data-v-88d54171${o3}>(\u5206\u7C7B\u4E0D\u597D\u7528,\u7528\u641C\u7D22)</span>`);
    }), _: 1 }, o2)), a3('<div class="flex justify-between m-b-10" data-v-88d54171>'), a3(ssrRenderComponent(_3, { modelValue: q.value, "onUpdate:modelValue": (e2) => q.value = e2, placeholder: "\u7C7B\u522B", size: "large" }, { default: withCtx((e2, l3, a4, o3) => {
      if (!l3)
      ...
      a4(ssrRenderComponent(w2, { prop: "name", label: "\u539F\u59CB\u6807\u7B7E", width: "320" }, { default: withCtx((e3, a5, o4, t4) => {
        ...
        a5(`<span class="m-r-12" data-v-88d54171${t4}>${ssrInterpolate((null == (r3 = e3.row) ? void 0 : r3.name) || "")}</span>`), a5(ssrRenderComponent(O2, { size: "small", circle: "", onClick: (l3) => {
          var a6;
          return unref(R$1)((null == (a6 = e3.row) ? void 0 : a6.name) || "");
    ...
    }), _: 3 }, o2)), a3('<div class="demo-pagination-block" data-v-88d54171>'), a3(ssrRenderComponent(E3, { "current-page": D.value, "onUpdate:current-page": (e2) => D.value = e2, "page-size": H.value, "onUpdate:page-size": (e2) => H.value = e2, "page-sizes": [10, 20, 50, 100], background: true, layout: "total, sizes, prev, pager, next, jumper", total: J.value, onSizeChange: P, onCurrentChange: Q }, null, o2)), a3("</div></div>");
  };
} }), E = B.setup;
B.setup = (e2, l2) => {
  const a2 = useSSRContext();
  return (a2.modules || (a2.modules = /* @__PURE__ */ new Set())).add("pages/mobile/tags/components/gelbooru.vue"), E ? E(e2, l2) : void 0;
};
const F = di(B, [["__scopeId", "data-v-88d54171"]]);
