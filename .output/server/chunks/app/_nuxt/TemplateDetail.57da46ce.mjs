...
const h = defineComponent({ __name: "TemplateDetail", __ssrInlineRender: true, props: ["modelValue", "currentTemplate"], emits: ["update:modelValue"], setup(n2, { emit: m2 }) {
  ...
  return (l2, t2, m3, c2) => {
    const f2 = o, b3 = n;
    t2(`<div${ssrRenderAttrs(c2)} data-v-04e5ef08>`), t2(ssrRenderComponent(f2, null, { default: withCtx((e2, l3, t3, a2) => {
      var m4, c3, f3, $2, T2, h3, w2, g2, V, D, A, E, I, L, S, Y, R, q, B, F, G, H, J, K, M, N, O, P, Q, U, W, X, Z, ee, ne, le, te, ae, re, pe, ue, de, oe, ve, ie, se, me, ce, fe, $e, Te, ke, _e, xe, be, he, ye, ze;
      if (!l3)
        ...
        } }, null, 8, ["onClick"])])])) : createCommentVNode("", true), unref(z2) ? (openBlock(), createBlock(Fragment, { key: 4 }, [(null == (re = n2.currentTemplate) ? void 0 : re.prompt_zh) ? (openBlock(), createBlock("div", { key: 0 }, [createVNode("span", null, "prompt_zh :"), createVNode("span", null, [createTextVNode(toDisplayString(null == (pe = n2.currentTemplate) ? void 0 : pe.prompt_zh) + " ", 1), createVNode(b3, { onClick: (e3) => {
          var l4;
          return unref(y2)(null == (l4 = n2.currentTemplate) ? void 0 : l4.prompt_zh);
        } }, null, 8, ["onClick"])])])) : createCommentVNode("", true), (null == (ue = n2.currentTemplate) ? void 0 : ue.n_prompt) ? (openBlock(), createBlock("div", { key: 1 }, [createVNode("span", null, "n_prompt :"), createVNode("span", null, [createTextVNode(toDisplayString(null == (de = n2.currentTemplate) ? void 0 : de.n_prompt) + " ", 1), createVNode(b3, { onClick: (e3) => {
          var l4;
      ...
      n2.modelValue ? (l3(`<div class="template-preview" data-v-04e5ef08${a2}><div class="preview-wrap" data-v-04e5ef08${a2}></div><div class="preview-con" data-v-04e5ef08${a2}><div class="right" data-v-04e5ef08${a2}><div class="image-con" data-v-04e5ef08${a2}><img${ssrRenderAttr("src", null == (m4 = n2.currentTemplate) ? void 0 : m4.preview)} alt="" data-v-04e5ef08${a2}></div></div>`), n2.currentTemplate ? (l3(`<div class="left" data-v-04e5ef08${a2}>`), `${null == (c3 = n2.currentTemplate) ? void 0 : c3.name}` ? l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>name :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (f3 = n2.currentTemplate) ? void 0 : f3.name)}</span></div>`) : l3("<!---->"), (null == ($2 = n2.currentTemplate) ? void 0 : $2.author) ? l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>author :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (T2 = n2.currentTemplate) ? void 0 : T2.author)}</span></div>`) : l3("<!---->"), `${null == (h3 = n2.currentTemplate) ? void 0 : h3.like}` ? l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>like :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (w2 = n2.currentTemplate) ? void 0 : w2.like)}</span></div>`) : l3("<!---->"), `${null == (g2 = n2.currentTemplate) ? void 0 : g2.prompt}` ? (l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>prompt :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (V = n2.currentTemplate) ? void 0 : V.prompt)} `), l3(ssrRenderComponent(b3, { onClick: (e3) => {
        var l4;
        return unref(y2)(null == (l4 = n2.currentTemplate) ? void 0 : l4.prompt);
      } }, null, t3, a2)), l3("</span></div>")) : l3("<!---->"), unref(z2) ? (l3("<!--[-->"), (null == (D = n2.currentTemplate) ? void 0 : D.prompt_zh) ? (l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>prompt_zh :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (A = n2.currentTemplate) ? void 0 : A.prompt_zh)} `), l3(ssrRenderComponent(b3, { onClick: (e3) => {
        var l4;
        return unref(y2)(null == (l4 = n2.currentTemplate) ? void 0 : l4.prompt_zh);
      } }, null, t3, a2)), l3("</span></div>")) : l3("<!---->"), (null == (E = n2.currentTemplate) ? void 0 : E.n_prompt) ? (l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>n_prompt :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (I = n2.currentTemplate) ? void 0 : I.n_prompt)} `), l3(ssrRenderComponent(b3, { onClick: (e3) => {
        var l4;
        return unref(y2)(null == (l4 = n2.currentTemplate) ? void 0 : l4.n_prompt);
      } }, null, t3, a2)), l3("</span></div>")) : l3("<!---->"), (null == (L = n2.currentTemplate) ? void 0 : L.n_prompt_zh) ? (l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>n_prompt_zh :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (S = n2.currentTemplate) ? void 0 : S.n_prompt_zh)} `), l3(ssrRenderComponent(b3, { onClick: (e3) => {
        var l4;
        return unref(y2)(null == (l4 = n2.currentTemplate) ? void 0 : l4.n_prompt_zh);
      } }, null, t3, a2)), l3("</span></div>")) : l3("<!---->"), (null == (Y = n2.currentTemplate) ? void 0 : Y.step) ? l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>step :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (R = n2.currentTemplate) ? void 0 : R.step)}</span></div>`) : l3("<!---->"), (null == (q = n2.currentTemplate) ? void 0 : q.sampler) ? l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>sampler :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (B = n2.currentTemplate) ? void 0 : B.sampler)}</span></div>`) : l3("<!---->"), (null == (F = n2.currentTemplate) ? void 0 : F.scale) ? l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>scale :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (G = n2.currentTemplate) ? void 0 : G.scale)}</span></div>`) : l3("<!---->"), (null == (H = n2.currentTemplate) ? void 0 : H.seed) ? l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>seed :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (J = n2.currentTemplate) ? void 0 : J.seed)}</span></div>`) : l3("<!---->"), (null == (K = n2.currentTemplate) ? void 0 : K.size) ? l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>size :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (M = n2.currentTemplate) ? void 0 : M.size)}</span></div>`) : l3("<!---->"), (null == (N = n2.currentTemplate) ? void 0 : N.model) ? l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>model :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (O = n2.currentTemplate) ? void 0 : O.model)}</span></div>`) : l3("<!---->"), (null == (P = n2.currentTemplate) ? void 0 : P.desc) ? l3(`<div data-v-04e5ef08${a2}><span data-v-04e5ef08${a2}>desc :</span><span data-v-04e5ef08${a2}>${ssrInterpolate(null == (Q = n2.currentTemplate) ? void 0 : Q.desc)}</span></div>`) : l3("<!---->"), l3("<!--]-->")) : l3("<!---->"), l3("</div>")) : l3("<!---->"), l3(`<div class="button-con" data-v-04e5ef08${a2}><button class="btn btn-secondary btn-sm m-r-10" data-v-04e5ef08${a2}>\u5173\u95ED</button><button class="btn btn-accent btn-sm m-r-10" data-v-04e5ef08${a2}> \u67E5\u770B\u66F4\u591A </button><button class="btn btn-primary btn-sm" data-v-04e5ef08${a2}> \u5BFC\u5165\u8D2D\u7269\u8F66 </button></div></div></div>`)) : l3("<!---->");
    }), _: 1 }, m3)), t2("</div>");
  };
} }), y = h.setup;
h.setup = (e2, n2) => {
...
const z = di(h, [["__scopeId", "data-v-04e5ef08"]]);
