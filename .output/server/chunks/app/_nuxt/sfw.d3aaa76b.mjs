...
const M = defineComponent({ __name: "sfw", __ssrInlineRender: true, setup(t2) {
  ...
  return (t3, o2, u3, i2) => {
    ...
    o2(`<div${ssrRenderAttrs(mergeProps({ class: "template-page page" }, i2))} data-v-ef9e7b1b>`), o2(ssrRenderComponent(s2, { name: "mobile" }, { default: withCtx((e2, t4, l2, a2) => {
      if (!t4)
      ...
      t4(ssrRenderComponent(j2, null, null, l2, a2)), t4(`<div class="content" data-v-ef9e7b1b${a2}><div class="banner-con" data-v-ef9e7b1b${a2}>`), t4(ssrRenderComponent(I2, { placeholder: "\u8BF7\u8F93\u5165\u5173\u952E\u6807\u7B7E" }, null, l2, a2)), t4("</div>"), t4(ssrRenderComponent(j2, null, null, l2, a2)), t4(ssrRenderComponent(j2, null, null, l2, a2)), t4(`<div class="demo-pagination-block" data-v-ef9e7b1b${a2}>`), unref(T2) && unref(T2) > 0 ? (t4(`<div class="btn-group" data-v-ef9e7b1b${a2}><button class="btn btn-outline" data-v-ef9e7b1b${a2}>\u9996\u9875</button><button class="btn btn-outline" data-v-ef9e7b1b${a2}>\u4E0A\u4E00\u9875</button><!--[-->`), ssrRenderList(unref(z$1), (e3, l3) => {
        t4(`<button class="${ssrRenderClass([{ "btn-active": e3 === unref(k2) }, "btn"])}" data-v-ef9e7b1b${a2}>${ssrInterpolate(e3)}</button>`);
      }), t4("<!--]-->"), unref(k2) < unref(T2) - 3 ? t4(`<button class="btn" data-v-ef9e7b1b${a2}>...</button>`) : t4("<!---->"), t4(`<button class="${ssrRenderClass([{ "btn-active": unref(T2) === unref(k2) }, "btn"])}" data-v-ef9e7b1b${a2}>${ssrInterpolate(unref(T2))}</button><button class="btn btn-outline" data-v-ef9e7b1b${a2}>\u4E0B\u4E00\u9875</button><button class="btn btn-outline" data-v-ef9e7b1b${a2}>\u5C3E\u9875</button><input${ssrRenderAttr("value", unref(k2))} type="text" placeholder="go" class="w-24 max-w-xs input input-bordered" data-v-ef9e7b1b${a2}></div>`)) : t4("<!---->"), t4("</div></div>"), t4(ssrRenderComponent(M3, { modelValue: unref(K), "onUpdate:modelValue": (e3) => isRef(K) ? K.value = e3 : null, "current-template": unref(X) }, null, l2, a2));
    }), _: 1 }, u3)), o2("</div>");
  };
} }), T = M.setup;
M.setup = (e2, t2) => {
  const l2 = useSSRContext();
  return (l2.modules || (l2.modules = /* @__PURE__ */ new Set())).add("pages/mobile/template/sfw.vue"), T ? T(e2, t2) : void 0;
};
