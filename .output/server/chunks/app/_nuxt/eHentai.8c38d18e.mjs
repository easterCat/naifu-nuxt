...
const S = defineComponent({ __name: "eHentai", __ssrInlineRender: true, props: { searchText: { type: String, default: "" } }, async setup(i2) {
  ...
  const N = (e2) => {
    ...
    a2 && (T.value = 1, H.value = a2.slice(50 * (T.value - 1), 50 * T.value), A$1.value = a2.length);
  }, 1e3);
  return (a2, t2, l2, i3) => {
...
const C = di(S, [["__scopeId", "data-v-187bf4ca"]]);
