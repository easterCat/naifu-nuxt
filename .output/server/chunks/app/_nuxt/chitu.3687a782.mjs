...
import { a as R$1 } from './AppHeader.1cc5a687.mjs';
...
const B = defineComponent({ __name: "chitu", __ssrInlineRender: true, setup(r2) {
  ...
  return onUnmounted(() => {
    ...
    const r3 = n, m2 = $t, p2 = g, v2 = d, F2 = R$1, B3 = ElSwitch, D3 = f, O2 = ElTooltip, K2 = t, P2 = a, Q2 = y, W2 = resolveDirective("animate-css");
    s2(`<div${ssrRenderAttrs(mergeProps({ class: "chitu-tags-page page" }, d2))} data-v-03ce3c99>`), s2(ssrRenderComponent(r3, null, { default: withCtx((e2, l2, t2, n2) => {
      if (!l2)
        return [createVNode(m2)];
      l2(ssrRenderComponent(m2, null, null, t2, n2));
    }), _: 1 }, u2)), s2('<div class="content" data-v-03ce3c99>'), s2(ssrRenderComponent(p2, { placeholder: "\u641C\u7D22\u6807\u7B7E", onSearchChange: ne }, null, u2)), s2(ssrRenderComponent(v2, mergeProps({ title: "\u6807\u7B7E\u7C7B\u522B" }, ssrGetDirectiveProps(c2, W2, { direction: "modifySlideInUp" })), null, u2)), s2('<div class="type-list" data-v-03ce3c99>'), s2(ssrRenderComponent(r3, null, { default: withCtx((e2, l2, t2, n2) => {
      if (!l2)
        return [(openBlock(true), createBlock(Fragment, null, renderList(unref(R2), (e3, l3) => withDirectives((openBlock(), createBlock(F2, { key: l3, index: l3 + "", "button-style": 1, "button-size": "larger", class: [l3 === J.value ? "btn-accent" : "btn-primary-30"], "button-text": null == e3 ? void 0 : e3.name, onSubmit: (e4) => te(l3) }, null, 8, ["index", "class", "button-text", "onSubmit"])), [[W2, { direction: "modifySlideInUp", delay: 40 * l3 }]])), 128))];
      l2("<!--[-->"), ssrRenderList(unref(R2), (e3, i2) => {
        l2(ssrRenderComponent(F2, mergeProps({ key: i2, index: i2 + "", "button-style": 1, "button-size": "larger", class: [i2 === J.value ? "btn-accent" : "btn-primary-30"], "button-text": null == e3 ? void 0 : e3.name, onSubmit: (e4) => te(i2) }, ssrGetDirectiveProps(c2, W2, { direction: "modifySlideInUp", delay: 40 * i2 })), null, t2, n2));
      }), l2("<!--]-->");
    }), _: 1 }, u2)), s2("</div>"), s2(ssrRenderComponent(v2, mergeProps({ title: "\u6807\u7B7E\u5217\u8868" }, ssrGetDirectiveProps(c2, W2, { direction: "modifySlideInUp" })), { titleSide: withCtx((e2, l2, t2, n2) => {
      if (!l2)
    ...
    }), _: 1 }, u2)), unref(Z) ? (s2('<div class="tag-list" data-v-03ce3c99>'), s2(ssrRenderComponent(r3, null, { default: withCtx((e2, l2, t2, n2) => {
      if (!l2)
      ...
      l2("<!--[-->"), ssrRenderList(Y.value, (e3, i2) => {
        var a2;
        l2(`<div${ssrRenderAttrs(mergeProps({ key: i2, class: "tag-item-img ll-media bg-base-100", "data-index": i2 }, ssrGetDirectiveProps(c2, W2, { direction: "modifySlideInUp", delay: 40 * i2 })))} data-v-03ce3c99${n2}>`), M.value && 5 !== J.value && 6 !== J.value ? (l2(`<div class="image-con" data-v-03ce3c99${n2}>`), (null == e3 ? void 0 : e3.min_imgbb_url) ? l2(ssrRenderComponent(D3, { src: null != (a2 = null == e3 ? void 0 : e3.min_imgbb_url) ? a2 : "", placeholder: [100, 50, 10], loading: "lazy", onClick: (l3) => le(e3) }, null, t2, n2)) : l2("<!---->"), l2("</div>")) : l2("<!---->"), l2(`<div class="text-con" data-v-03ce3c99${n2}>`), l2(ssrRenderComponent(O2, { class: "box-item", effect: "dark", content: null == e3 ? void 0 : e3.promptEN, placement: "top" }, { default: withCtx((l3, t3, n3, i3) => {
          if (!t3)
          ...
          (null == e3 ? void 0 : e3.title) ? t3(`<p class="en" data-v-03ce3c99${i3}>${ssrInterpolate((null == e3 ? void 0 : e3.title.length) > 24 ? (null == e3 ? void 0 : e3.title.slice(0, 24)) + "..." : null == e3 ? void 0 : e3.title)}</p>`) : t3(`<p class="en" data-v-03ce3c99${i3}>${ssrInterpolate((null == e3 ? void 0 : e3.promptEN.length) > 24 ? (null == e3 ? void 0 : e3.promptEN.slice(0, 24)) + "..." : null == e3 ? void 0 : e3.promptEN)}</p>`);
        }), _: 2 }, t2, n2)), l2(`</div><div class="button-con" data-v-03ce3c99${n2}><button class="btn btn-sm btn-circle btn-accent m-r-10" data-v-03ce3c99${n2}>`), l2(ssrRenderComponent(K2, null, null, t2, n2)), l2(`</button><button class="btn btn-sm btn-circle btn-secondary" data-v-03ce3c99${n2}>`), l2(ssrRenderComponent(P2, null, null, t2, n2)), l2("</button></div></div>");
      }), l2("<!--]-->");
    }), _: 1 }, u2)), s2("</div>")) : s2("<!---->"), J.value ? (s2('<div class="tag-list" data-v-03ce3c99>'), s2(ssrRenderComponent(r3, null, { default: withCtx((e2, l2, t2, n2) => {
      if (!l2)
      ...
      l2("<!--[-->"), ssrRenderList(Y.value, (e3, i2) => {
        l2(`<div${ssrRenderAttrs(mergeProps({ key: i2, class: "tag-item-img ll-media bg-base-100", "data-index": i2 }, ssrGetDirectiveProps(c2, W2, { direction: "modifySlideInUp", delay: 40 * i2 })))} data-v-03ce3c99${n2}>`), M.value && 5 !== J.value && 6 !== J.value ? (l2(`<div class="image-con" data-v-03ce3c99${n2}>`), (null == e3 ? void 0 : e3.fileUrl) ? l2(ssrRenderComponent(D3, { src: null == e3 ? void 0 : e3.fileUrl, placeholder: [100, 50, 10], loading: "lazy", onClick: (l3) => le(e3) }, null, t2, n2)) : l2("<!---->"), l2("</div>")) : l2("<!---->"), l2(`<div class="text-con" data-v-03ce3c99${n2}>`), l2(ssrRenderComponent(O2, { class: "box-item", effect: "dark", content: null == e3 ? void 0 : e3.promptEN, placement: "top" }, { default: withCtx((l3, t3, n3, i3) => {
          if (!t3)
            return [(null == e3 ? void 0 : e3.title) ? (openBlock(), createBlock("p", { key: 0, class: "en" }, toDisplayString((null == e3 ? void 0 : e3.title.length) > 24 ? (null == e3 ? void 0 : e3.title.slice(0, 24)) + "..." : null == e3 ? void 0 : e3.title), 1)) : (openBlock(), createBlock("p", { key: 1, class: "en" }, toDisplayString((null == e3 ? void 0 : e3.promptEN.length) > 24 ? (null == e3 ? void 0 : e3.promptEN.slice(0, 24)) + "..." : null == e3 ? void 0 : e3.promptEN), 1))];
          (null == e3 ? void 0 : e3.title) ? t3(`<p class="en" data-v-03ce3c99${i3}>${ssrInterpolate((null == e3 ? void 0 : e3.title.length) > 24 ? (null == e3 ? void 0 : e3.title.slice(0, 24)) + "..." : null == e3 ? void 0 : e3.title)}</p>`) : t3(`<p class="en" data-v-03ce3c99${i3}>${ssrInterpolate((null == e3 ? void 0 : e3.promptEN.length) > 24 ? (null == e3 ? void 0 : e3.promptEN.slice(0, 24)) + "..." : null == e3 ? void 0 : e3.promptEN)}</p>`);
        }), _: 2 }, t2, n2)), l2(`</div><div class="button-con" data-v-03ce3c99${n2}><button class="btn btn-sm btn-circle btn-accent m-r-10" data-v-03ce3c99${n2}>`), l2(ssrRenderComponent(K2, null, null, t2, n2)), l2(`</button><button class="btn btn-sm btn-circle btn-secondary" data-v-03ce3c99${n2}>`), l2(ssrRenderComponent(P2, null, null, t2, n2)), l2("</button></div></div>");
      }), l2("<!--]-->");
    }), _: 1 }, u2)), s2("</div>")) : (s2('<div class="tag-list" data-v-03ce3c99><!--[-->'), ssrRenderList(Y.value, (e2, l2) => {
      var t2;
      s2(`<div class="tag-item-img ll-media bg-base-100"${ssrRenderAttr("data-index", l2)} data-v-03ce3c99>`), M.value && 5 !== J.value && 6 !== J.value ? (s2('<div class="image-con" data-v-03ce3c99>'), (null == e2 ? void 0 : e2.min_imgbb_url) ? s2(ssrRenderComponent(D3, { src: null != (t2 = null == e2 ? void 0 : e2.min_imgbb_url) ? t2 : "", placeholder: [100, 50, 10], loading: "lazy", onClick: (l3) => le(e2) }, null, u2)) : s2("<!---->"), s2("</div>")) : s2("<!---->"), s2('<div class="text-con" data-v-03ce3c99>'), s2(ssrRenderComponent(O2, { class: "box-item", effect: "dark", content: null == e2 ? void 0 : e2.prompt, placement: "top" }, { default: withCtx((l3, t3, n2, i2) => {
        if (!t3)
        ...
        (null == e2 ? void 0 : e2.title) ? t3(`<p class="en" data-v-03ce3c99${i2}>${ssrInterpolate((null == e2 ? void 0 : e2.title.length) > 24 ? (null == e2 ? void 0 : e2.title.slice(0, 24)) + "..." : null == e2 ? void 0 : e2.title)}</p>`) : t3(`<p class="en" data-v-03ce3c99${i2}>${ssrInterpolate((null == e2 ? void 0 : e2.prompt.length) > 24 ? (null == e2 ? void 0 : e2.prompt.slice(0, 24)) + "..." : null == e2 ? void 0 : e2.prompt)}</p>`);
      }), _: 2 }, u2)), s2('</div><div class="button-con" data-v-03ce3c99><button class="btn btn-sm btn-circle btn-accent m-r-10" data-v-03ce3c99>'), s2(ssrRenderComponent(K2, null, null, u2)), s2('</button><button class="btn btn-sm btn-circle btn-secondary" data-v-03ce3c99>'), s2(ssrRenderComponent(P2, null, null, u2)), s2("</button></div></div>");
    }), s2("<!--]--></div>")), s2("</div>"), s2(ssrRenderComponent(Q2, { modelValue: G.value, "onUpdate:modelValue": (e2) => G.value = e2, "current-template": q.value }, null, u2)), s2("</div>");
  };
} }), D = B.setup;
B.setup = (e2, l2) => {
...
const R = di(B, [["__scopeId", "data-v-03ce3c99"]]);
